class BodyRepairNavigation extends HTMLElement {
    constructor() {
        super();
        this.navItems = [
            { id: 'about', icon: 'info-circle', text: 'Про послугу' },
            { id: 'services', icon: 'tools', text: 'Види робіт' },
            { id: 'process', icon: 'cogs', text: 'Процес ремонту' },
            { id: 'advantages', icon: 'star', text: 'Переваги' },
            { id: 'gallery', icon: 'images', text: 'Галерея' },
...
customElements.define('body-repair-navigation', BodyRepairNavigation); 