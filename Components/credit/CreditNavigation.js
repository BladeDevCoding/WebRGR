class CreditNavigation extends HTMLElement {
    constructor() {
        super();
        this.navItems = [
            { id: 'credit-section', icon: 'credit-card', text: 'Кредитування' },
            { id: 'calculator-section', icon: 'calculator', text: 'Калькулятор' },
            { id: 'leasing-section', icon: 'file-contract', text: 'Лізинг' },
            { id: 'partners-section', icon: 'handshake', text: 'Партнери' },
            { id: 'faq-section', icon: 'question-circle', text: 'FAQ' },
            { id: 'form-section', icon: 'paper-plane', text: 'Заявка' }
        ];
    }
...
customElements.define('credit-navigation', CreditNavigation); 