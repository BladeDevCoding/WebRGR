class InsuranceNavigation extends HTMLElement {
    constructor() {
        super();
        this.navItems = [
            { id: 'insurance-types', icon: 'shield-alt', text: 'Види страхування' },
            { id: 'osago', icon: 'file-contract', text: 'ОСЦПВ' },
            { id: 'kasko', icon: 'car-crash', text: 'КАСКО' },
            { id: 'green-card', icon: 'globe-europe', text: 'Зелена картка' },
            { id: 'calculator', icon: 'calculator', text: 'Калькулятор' },
...
customElements.define('insurance-navigation', InsuranceNavigation); 