...
class ServiceDetails extends HTMLElement {
    ...
    async loadOfferDetails() {
        try {
            ...
            if (!slug) {
                this.showError('Акцію не знайдено');
                return;
            }

            const offer = await ServiceOffersService.getServiceOfferBySlug(slug);
            ...
            console.error('Error loading service offer details:', error);
        ...
        modalContent.innerHTML = `
            <div class="text-center py-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Наш менеджер зв'яжеться з вами для підтвердження запису на сервіс
                </p>
    ...
    showError(message) {
        this.innerHTML = `
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">Спробуйте повернутися на сторінку всіх акцій</p>
                <a href="service-offers.html" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200">
                    <i class="fas fa-arrow-left mr-2"></i> До сервісних акцій
                </a>
            </div>
        `;
    }
        ...
        this.innerHTML = `
            <div>
                ...
                <div class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-6">
                    ...
                    <a href="service-offers.html" class="hover:text-indigo-600 dark:hover:text-indigo-400">Сервісні акції</a>
                    <i class="fas fa-chevron-right mx-2 text-xs"></i>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex items-baseline mb-6">
                            ${this.offer.price === "0" 
                                ? `<span class="text-3xl font-bold text-green-600 dark:text-green-400">Безкоштовно</span>` 
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <a href="service-offers.html" class="inline-flex items-center px-6 py-3 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white font-medium rounded-lg transition-colors duration-200 border border-gray-200 dark:border-gray-600">
                                <i class="fas fa-arrow-left mr-2"></i> До всіх акцій
                            </a>
                        </div>
                    </div>
                </div>
