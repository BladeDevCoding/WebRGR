class ServiceAdvantages extends HTMLElement {
    constructor() {
        super();
        this.advantages = [
            {
            ...
            },
            {
                icon: 'calendar-alt',
                title: 'Зручний запис',
                description: 'Онлайн-запис на сервіс у зручний для вас час'
            },
            {
                icon: 'user-tie',
...
customElements.define('service-advantages', ServiceAdvantages); 