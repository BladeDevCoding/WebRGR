class TradeInNavigation extends HTMLElement {
    constructor() {
        super();
        this.navItems = [
            { id: 'how-it-works', icon: 'exchange-alt', text: 'Як це працює' },
            { id: 'benefits', icon: 'check-circle', text: 'Переваги' },
            { id: 'evaluation', icon: 'search-dollar', text: 'Оцінка авто' },
            { id: 'form-section', icon: 'file-alt', text: 'Заявка' },
            { id: 'faq-section', icon: 'question-circle', text: 'FAQ' },
            { id: 'contact-section', icon: 'phone-alt', text: 'Контакти' }
        ];
    }
...
customElements.define('trade-in-navigation', TradeInNavigation); 