class WarrantyNavigation extends HTMLElement {
    constructor() {
        super();
        this.navItems = [
            { id: 'warranty-info', icon: 'shield-alt', text: 'Про гарантію' },
            { id: 'warranty-conditions', icon: 'file-contract', text: 'Умови' },
            { id: 'warranty-service', icon: 'tools', text: 'Обслуговування' },
            { id: 'warranty-extension', icon: 'calendar-plus', text: 'Продовження' },
            { id: 'warranty-faq', icon: 'question-circle', text: 'FAQ' },
            { id: 'service-form', icon: 'paper-plane', text: 'Запис на сервіс' }
        ];
    }
...
customElements.define('warranty-navigation', WarrantyNavigation); 